...
// in the register. If we do another MULT at this point, the stack is mutated
...
output: no return value; prints to console when `'PRINT'` command given

- Create variable to track register value;
- Create variable to track stack with an array
- Split input string at spaces to creat list of commands
- For each command:
  - Execute given command:
    - Match given command with potential commands to perform necessary steps
