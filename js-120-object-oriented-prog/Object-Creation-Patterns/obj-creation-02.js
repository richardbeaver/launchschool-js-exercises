...
// Implement the class diagram in the "Person-Class-Diagram.png" file using
// the pseudo-classical approach.
...
let graduateStudent = new GraduateStudent(
  'foo', 'bar', 21, 'gender', 'BS Industrial Engineering', 'MS Industrial Engineering'
);
...
function GraduateStudent(
  firstName, lastName, age, gender, degree, graduateDegree
) {
